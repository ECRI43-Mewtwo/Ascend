...
describe('Home Page Tests', () => {
  ...
  test('renders the application-edit-page-form', async () => {
    const applicationEditPageForm = await screen.querySelector(
      '#application-edit-page-form'
    );
    expect(applicationEditPageForm).toBeInTheDocument();
  });
  test('render application-edit-page-update-box', async () => {
    const applicationEditPageUpdateBox = await screen.querySelector(
      '#application-edit-page-update-box'
    );
